package com.hoyozero.deploy.websocket;
...
public class ProjectLogSocket {
    ...
    private static ProjectServerService projectServerService;
     ...
     * 启动 tail -f 日志监控
     */
    private void startTailLog(jakarta.websocket.Session wsSession, String key, Project project, Server server, String customLogPath) {
